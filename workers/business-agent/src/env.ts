...
export interface Env {
  ...
  MAILBOX_PROCESSING_ENABLED?: string;
  MAILBOX_TRIAGE_ENABLED?: string;
  MAILBOX_TRIAGE_DISPATCH_ENABLED?: string;
  MAILBOX_EXTENDED_TRIAGE_ENABLED?: string;
  MAILBOX_EXTENDED_JOBS_ENABLED?: string;
