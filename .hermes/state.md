...
| live_url_status                | up                                       |
| deployed_sha                   | ef12663 (unchanged — turn-029 docs-only, deploy workflow filtered out docs/**; live site still on turn-027 sha) |
