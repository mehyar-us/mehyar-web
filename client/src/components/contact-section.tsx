...
const nextSteps = [
  "Mehyar reviews the request personally.",
          ...
          <aside className="space-y-6">
            <Card className="border-border bg-card shadow-[0_18px_60px_rgba(8,63,84,0.08)] dark:shadow-[0_18px_60px_rgba(0,0,0,0.28)]">
              <CardContent className="p-6">
                <h3 className="mb-4 text-xl font-semibold text-ink dark:text-white">
                  What to include
                </h3>
                <div className="space-y-3">
                  {includeItems.map((item) => (
                    ...
                    >
                      <CheckCircle2
                        size={17}
                        className="mt-0.5 flex-shrink-0 text-brand-700 dark:text-brand-100"
                        aria-hidden="true"
                      />
                      <span>{item}</span>
                    </div>
              ...
              <CardContent className="p-6">
                ...
                <div className="mb-5 space-y-3">
                  {nextSteps.map((step, index) => (
                    ...
                    >
                      <span className="flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full bg-brand-800 text-xs font-bold text-white dark:bg-brand-100 dark:text-brand-950">
                        {index + 1}
                      </span>
                      <span>{step}</span>
                    </div>
            ...
            <div className="flex items-start rounded-2xl border border-border bg-card p-5">
              ...
              <div className="ml-4">
                ...
                <p className="mt-1 text-sm leading-6 text-muted-foreground">
                  If the security check fails, send the same short brief
                  directly.
                </p>
                <a
                  href="mailto:info@mehyar.us"
                  className="mt-2 inline-flex text-sm font-semibold text-brand-800 hover:text-brand-700 dark:text-brand-100"
                >
                  info@mehyar.us
                </a>
              </div>
