      ...
      <div className="container mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-neutral-700 dark:text-neutral-300 max-w-3xl mx-auto">
            Instead of publishing invented case studies, MehyarSoft shows the concrete types of problems it is built to solve and the outcomes each engagement is designed around.
          </p>
        </div>
