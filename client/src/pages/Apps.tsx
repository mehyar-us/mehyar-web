      ...
      <section className="bg-background px-4 pb-16 md:pb-20">
        <div className="mx-auto max-w-5xl rounded-2xl border border-border bg-card/50 p-6 text-sm leading-6 text-muted-foreground md:p-8">
          ...
          <p className="mt-2">
            ...
            for the full process, product-by-product details (Rizza, AiMech, Designful, Sprint30, BizBuilder, CreditFix Kit, HustleKit, TikTok Growth System, PLR Vault, PromptPack Pro, OpenSeason, BeachCall, CareRank, PureTap, TicketBeat), and the request form.
          </p>
        </div>
      </section>
    </>
