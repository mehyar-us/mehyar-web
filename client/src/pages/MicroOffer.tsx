...
const offerCards = [
  {
    ...
    solution:
      "Review the first impression, service clarity, CTA path, mobile flow, and trust gaps.",
    outcome:
      "You get a ranked fix list: what to clean up now, what to automate next, and what to defer.",
  },
  {
    icon: CalendarClock,
    ...
    solution:
      "Map the smallest booking/intake path with fields, confirmations, owner alerts, and handoff logic.",
    outcome:
      "You leave with the simplest next setup: booking link, form path, response script, or sprint scope.",
  },
  {
    icon: PhoneCall,
    ...
    solution:
      "Identify where consent-safe SMS/email follow-up and owner visibility can reduce leakage.",
    outcome:
      "You know whether a lightweight follow-up flow is worth building before buying more software.",
  },
];
    ...
    <>
        ...
        <div className="container mx-auto grid gap-10 lg:grid-cols-[minmax(0,1.05fr)_minmax(320px,0.95fr)] lg:items-center">
          <div>
            ...
            <h1 className="max-w-4xl text-4xl font-semibold tracking-[-0.045em] text-ink dark:text-white sm:text-5xl lg:text-6xl">
              Find where your website, booking path, or follow-up is losing
              customers.
            </h1>
            <p className="mt-6 max-w-2xl text-lg leading-8 text-muted-foreground sm:text-xl sm:leading-9">
              A focused founder-led audit for small businesses that know
              something is leaking — bad website clarity, missed calls, manual
              booking, weak follow-up, or disconnected systems — but need the
              next move before committing to a larger build.
            </p>
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              ...
              >
                Request the $330 audit/setup path
              </a>
              <a
                href="#included"
                className={cn(
          ...
          <aside className="rounded-[2rem] border border-border bg-card/92 p-5 shadow-[0_24px_80px_rgba(8,63,84,0.12)] dark:bg-card/88 dark:shadow-[0_24px_80px_rgba(0,0,0,0.32)] sm:p-7">
            ...
            <div className="mt-5 space-y-3">
              {fitSignals.map((signal) => (
                <div
                  key={signal}
                  className="flex gap-3 rounded-2xl bg-brand-100/60 p-3 text-sm leading-6 text-muted-foreground dark:bg-white/[0.04]"
                >
                  <CheckCircle2
                    size={17}
                    className="mt-1 flex-shrink-0 text-brand-700 dark:text-brand-100"
                    aria-hidden="true"
                  />
                  <span>{signal}</span>
                </div>
      ...
      <section id="included" className="px-4 py-16 sm:py-20">
        <div className="container mx-auto">
          <div className="mx-auto mb-10 max-w-3xl text-center">
            ...
            <h2 className="text-3xl font-semibold tracking-[-0.035em] text-ink dark:text-white md:text-5xl">
              A clear decision path, not a bloated proposal.
            </h2>
          </div>
          <div className="grid gap-5 lg:grid-cols-3">
            {offerCards.map((card) => {
              ...
              return (
                <article
                  key={card.title}
                  className="rounded-[1.75rem] border border-border bg-card p-6 shadow-[0_18px_60px_rgba(8,63,84,0.08)] dark:shadow-[0_18px_60px_rgba(0,0,0,0.28)]"
                >
          ...
          <div className="mt-10 grid gap-6 rounded-[2rem] border border-border bg-white p-5 dark:bg-white/[0.04] sm:p-7 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
            <div>
              ...
              <h3 className="mt-3 text-2xl font-semibold tracking-[-0.03em] text-ink dark:text-white">
                The audit is designed to turn uncertainty into one next action.
              </h3>
            </div>
      ...
      <section className="bg-brand-950 px-4 py-16 text-white dark:bg-brand-900 sm:py-20">
        <div className="container mx-auto grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <div>
            <p className="mb-3 text-sm font-semibold uppercase tracking-[0.24em] text-brand-100">
              Credibility fit
            </p>
            <h2 className="text-3xl font-semibold tracking-[-0.035em] md:text-5xl">
              Built for owner-led businesses and regulated teams that need
              clarity.
            </h2>
          </div>
          <div className="space-y-4 text-base leading-8 text-white/78">
            <p>
              MehyarSoft is founder-led by Mehyar Swelim, a senior
              software/systems consultant with 10+ years of professional
              engineering experience and current pharma systems-engineering
              work.
            </p>
            <p>
              The point of the $330 path is restraint: identify the leak,
              protect the intake boundary, and recommend the smallest practical
              next step before proposing cleanup, booking setup, AI follow-up,
              or a larger automation sprint.
            </p>
          </div>
        </div>
      </section>
