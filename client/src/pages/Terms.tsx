      ...
      <>
        ...
        <ul className="mt-3 grid gap-2 sm:grid-cols-2">
          ...
          <li className="rounded-xl border border-border bg-card/60 p-3">
            ...
            <div className="text-sm text-muted-foreground">Branded client sites including mehyarmobile.com, rochelle.love, and white-label hosted PWAs under <code>connectree-*</code> / <code>blue-apple-space-*</code>.</div>
          </li>
        </ul>
      </>
    ),
