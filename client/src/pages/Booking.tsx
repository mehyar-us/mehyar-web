      ...
      <section className="px-4 pb-16 pt-28 sm:pb-20 bg-gradient-to-br from-primary/5 to-secondary/5 dark:from-primary/10 dark:to-secondary/10">
        <div className="container mx-auto text-center">
          ...
          <p className="mx-auto max-w-3xl text-lg leading-8 text-neutral-700 dark:text-neutral-300 md:text-xl">
            Pick Tech Audit, $330 Rescue, Website cleanup, AI follow-up,
            Automation sprint, Systems consulting, Retainer, or General. If live
            calendar auth is unavailable, this captures a manual scheduling
            request without faking open slots.
          </p>
        </div>
      </section>
      <QuickAnswer
